...
namespace ComputerNets1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            resultVisualisation = new ResultVisualisation(this); // ѕроверить Form на null внутри resultVisualisation
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (StreamWriter sw = new StreamWriter(inStreamPath, false))
            {
                ...
                {
                    sw.WriteLine($"{item.I}: врем€ прихода = {item.T}, tau = {item.Tau}, sigma = {item.Sigma}, delta = {item.Delta}");
                }
            }
    ...
    //{
    //    // сохранЄнное предыдущее значение
